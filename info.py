...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6351261772', '6432985073').split()] # Replace with the actual admin ID(s) to add
